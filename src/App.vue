...
<template>
	<div>
		...
		<nav
			...
			<ButtonFixed v-if="store.existeUsuario" href="post" icon="add"/>
			<ButtonFixed v-if="store.existeUsuario" href="notification" icon="notifications"/>
			<ButtonFixed v-if="store.existeUsuario" href="profile" icon="account_circle"/>
