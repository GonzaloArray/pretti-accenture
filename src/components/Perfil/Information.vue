...
<template>
    <section class="mt-4 py-3 position-relative bg-primario shadow text-white py-4 px-2">
        ...
        <div class="ms-3">
            <p class="mb-1 d-flex align-items-center">
                ...
                <span v-if="valor" class="fw-lighter">{{ info1 }}</span>
            ...
            <p class="mb-1 d-flex align-items-center">
                ...
                <span v-if="valor" class="fw-lighter">{{ info2 }}</span>
                <input v-else type="text" v-model="changeInfo.change2" :placeholder="info2">
            </p>
        </div>

        <button type="button" @click="handleEdit"
            class="btn btn-sm btn-success rounded-5 m-2 position-absolute top-0 end-0 shadow">
